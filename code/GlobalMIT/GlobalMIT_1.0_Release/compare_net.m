...
%       Network with the Mutual Information Test (MIT) Criterion, Bioinformatics, 2011-submitted for publication.
%Usage: [specificity, sensitivity,imprecision]=compare_net(net,true_net,verbose)
%Compare two network and calculate the quality metrics
% Input:
%       net: the discovered network
%       true_net: the ground-truth network
%       verbose: 1 for displaying detailed information
% Output:
